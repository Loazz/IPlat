local Spike = {img = love.graphics.newImage("assets/Spikes/Individual Spike.png")}
...
function Spike.new(x, y)
    ...
    instance.physics.shape = love.physics.newRectangleShape(instance.width * 0.6, instance.height * 0.6)
    ...
    for i,instance in ipairs(ActiveSpikes) do
        if a == instance.physics.fixture or b == instance.physics.fixture then
            if a == Player.physics.fixture or b == Player.physics.fixture then
                ...
                Sound:play("hurt", "default", 0.005, 1)
                return true
            end
        end
    end
